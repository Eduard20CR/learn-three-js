...
const tick = () => {
  ...
  //   const radius = 3;
  //   directionalLight.position.x = Math.cos(elapsedTime) * radius;
  //   directionalLight.position.z = Math.sin(elapsedTime) * radius;
  //   directionalLight.position.y = Math.cos(elapsedTime) + 1.5;
